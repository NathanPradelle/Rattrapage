          ...
          >
            ...
            {warehouses.map((warehouse) => (
              <option key={warehouse.id} value={warehouse.id}>
                {warehouse.name} - {warehouse.building_number}{' '}
                {warehouse.street}, {warehouse.city}, {warehouse.postal_code}
              </option>
            ))}
          </select>
          {errors.warehouse_id && (
            <div className='text-danger'>{errors.warehouse_id}</div>
          )}
        </div>
